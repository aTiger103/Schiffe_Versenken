...
bool Spieler::pruefenPlatzieren(std::string eingabe, int schiffGroesse){ // gehört zur Spieler-Definition
    ...
    void Spieler::spieler_Schiffe_platzieren(int schiffLeange, int anzahl, std::string typ){ // gehört zur Spieler-Definition
